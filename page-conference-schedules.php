<?php
/*
  Template Name: Conference Schedules
*/
?>
...
<?php get_header(); ?>
  ...
  <main id="main">
    <article>
      ...
      <section class="wrapper">
        <div class="btn__contact btn__back">
          <a class="btn nav__link" href="<?php echo site_url( '/conference-schedule' ); ?>">Conference Schedules</a>
        </div>
      </section>
